...
@fig-states is provided as a visual reference of the locations of these states for your convenience. 
...
>>>>>>> 31e5d7ab6b0e602db0beec3cd9bea8cd26c1644e

```{r}
#| echo: false
#| warning: false
#| label: tbl-shark-ktab
#| tbl-cap: "k-Table for Nearest Neighbor Analysis"

<<<<<<< HEAD
Because this a worst-case scenario, there are a few limitations. First, independence is most likely not present in the real-world scenario. According to author Tom Sherrington, "While it’s not a universal certainty, storms can indeed influence shark distribution and bring them closer to shore due to a complex interplay of environmental factors ... [it’s] important to note that not all shark species respond to storms in the same way. Some species, like bull sharks, are known for their tolerance of brackish water and are more likely to be found closer to shore even under normal conditions. Others, like great white sharks, may venture closer to shore in search of larger prey that have been impacted by the storm" [@sherringtonStormsBringSharks2024].
As noted in @tbl-sharks, the most common species of sharks captured were the Atlantic Sharpnose and the Sandbar, and both species are sensitive to changes caused by tornados and hurricanes. This means that the calculated figure (0.13%) is likely an [overestimation of the true probability]{.underline}, given the fact that as a result of environmental conditions, these sharks will move further below the surface and/or away from the tornado. This means that the true probability will be less than 0.13%.

::: callout-note

I'd avoid using .underline and focus instead on using *italics* -- underline can mean hyperlink to some people. Minor quibble. Otherwise this looks awesome.
...
#| warning: false
#| label: tbl-shark-nnc
#| tbl-cap: "Classifications of Tornados based on Location to Shark-Populated Waters (k=1)"
...
@tbl-shark-ktab is a table of k-Nearest Neighbor classification success rates. This table was used to select a value of k that best classifies tornado locations based on the proximity of sharks, conditioned on both the tornado and shark being located in the buffer. Based on this analysis, k=9 was used as it has a maximum overall success rate of 95.71%.
