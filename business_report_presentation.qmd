...
## Recommendations {background-image="rhizo.jpg" background-size="cover" background-opacity="0.20"}

::: {style="display: inline-block; background-color: white; border: 5px solid black; padding: 20px 40px; border-radius: 10px;"}
...
## Limitations {background-image="shark-floor.jpg" background-size="cover" background-opacity="0.30"}

::: {style="display: inline-block; background-color: white; border: 5px solid black; padding: 20px 40px; border-radius: 10px;"}
-   Need Separate Analysis done on Hurricane Potential
-   No Analysis done on Inland Shark Population Areas (Zoos, Aquariums, Labs)
-   Analysis Scope Limited to Certain States
:::

## {background-image="ocean.jpg" background-size="cover" background-opacity="0.5"}

::: {.absolute top="50%" left="50%" style="transform: translate(-50%, -50%);"}
::: {style="display: inline-block; background-color: white; border: 5px solid black; padding: 20px 40px; font-size: 2.5em; font-weight: bold; border-radius: 10px; text-align: center;"}
Questions?
:::
:::
