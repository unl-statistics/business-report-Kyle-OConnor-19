...
@fig-states is provided as a visual reference of the locations of these states for convenience. 
...
plot(x = save.results.cv[,1], y = save.results.cv[,4], 
     main = "Overall Accuracy Rates for Values of K", panel.first = grid(), type = "o", 
